						...
						<div class="card-body box-profile">
							<div class="text-center">
								<a data-toggle="modal" data-target="#modal-profle" href="#">
									...
									src="<?php echo base_url('assets/images/user/' . get_profile(@$data['data']['user_id'])['img']) ?>"
									...
									<div class="modal-dialog modal-sm">
										<div class="modal-content">
											...
											<div class="modal-body">
												<img style=" max-width: 100%; max-height: 100%;" src='<?php echo base_url('assets/images/user/' . get_profile(@$data['data']['user_id'])['img']) ?>'>
											</div>
										</div>
										<!-- /.modal-content -->
									</div>
