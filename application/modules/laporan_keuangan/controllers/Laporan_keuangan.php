...
class Laporan_keuangan extends CI_Controller
{
	...
	{
		$data = $this->laporan_keuangan_model->rekap_pendapatan();
	...
	public function history_pembayaran()
	{
		...
		$config['base_url'] = base_url('laporan_keuangan/history_pembayaran');
		$config['total_rows'] = $this->laporan_keuangan_model->count_history_pembayaran();
		$config['per_page'] = 12;
		...
		$desa = $this->laporan_keuangan_model->desa();
		$data = $this->laporan_keuangan_model->history_pembayaran($config['per_page'], $url);
		$data['url'] = $url;
		$tempo = $this->laporan_keuangan_model->tempo();
		$date_pembayaran = $this->laporan_keuangan_model->date_pembayaran();
		$pelanggan = $this->pelanggan_model->for_api();
